package com.kaio.workshopmongo.config;
...
import com.kaio.workshopmongo.dto.AuthorDTO;
import com.kaio.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("21/03/2024"),new AuthorDTO(alex));
